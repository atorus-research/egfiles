...
For data files where you want to load the contents directly into R as a data frame, egfiles provides specialized functions like `eg_read_csv()`, `eg_read_excel()`, etc. See `vignette("reading-writing")` for those.
