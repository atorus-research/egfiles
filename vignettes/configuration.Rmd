...
4. Give the key a descriptive name (e.g., "R egnyte access")
...
With these environment variables set, you don't need to call `eg_auth()` at all. The package will automatically pick up the values from your environment when you use functions like `eg_read()` or `eg_write()`.
